...
public class DevQsarConstants {
	...
	// URLs for dev_qsar database web services
	public static final String QSAR_DATASETS_URL = "http://localhost:8080";
	public static final String QSAR_DESCRIPTORS_URL = "http://localhost:8082";
	public static final String QSAR_MODELS_URL = "http://localhost:8083";
	public static final String EXP_PROP_URL = "http://localhost:8088";
