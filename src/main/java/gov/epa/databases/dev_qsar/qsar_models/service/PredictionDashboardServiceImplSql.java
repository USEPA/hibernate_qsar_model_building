...
public class PredictionDashboardServiceImplSql implements PredictionDashboardService {
	Validator validator;
	 ...
	 */
	@Override
	public List<PredictionDashboard> createBatch(List<PredictionDashboard> predictionDashboards) {
...
//				saveToPredictionsDashboardTableNoKeys(predictionDashboards2, conn);
			...
			return predictionDashboards;//although might not need to return it (use original object which now has ids set)
...
//					System.out.println(i+"\t"+metadata.getColumnLabel(i)+"\t"+rs.getString(i));
	...
	public static void main(String[] args) {
		PredictionDashboardServiceImplSql p=new PredictionDashboardServiceImplSql();
	...
	@Override
	public PredictionDashboard create(PredictionDashboard predictionDashboard)
	...
	@Override
	public List<PredictionDashboard> createBatch(List<PredictionDashboard> predictionDashboard, Session session)
			throws org.hibernate.exception.ConstraintViolationException {
		// TODO Auto-generated method stub
		return null;
	}
