package gov.epa.run_from_java.scripts.PredictionDashboard.TEST.model;
...
//			TESTConstants.ChoiceEstrogenReceptorRelativeBindingAffinity,
	...
	public static String getPropertyNameDB(String propertyName) {
		...
		if (propertyName.equals(TESTConstants.ChoiceBoilingPoint))
			...
			return DevQsarConstants.VAPOR_PRESSURE;
