...
//	public FileOutputStream out;
	...
	public static void main(String [] args) {
		...
		PredictionReport predictionReport=p.generateForModelSetPredictions(datasetName,descriptorSetName, splittingName,modelSetName);
...
//		System.out.println("number of data points="+report.predictionReportDataPoints.size());
		...
		if (isBinary) {
			...
			double avgExpTraining=findExperimentalAverage(modelPredictions);
			...
			Map<String, Double> StatisticsMapTest = ModelStatisticCalculator.calculateContinuousStatistics(modelPredictions, avgExpTraining, DevQsarConstants.TAG_TEST);
			
//			TODO This is wrong- needs to just use chemicals appearing in the training set
			Map<String, Double> StatisticsMapTrain = ModelStatisticCalculator.calculateContinuousStatistics(modelPredictions, avgExpTraining, DevQsarConstants.TAG_TRAINING);
