...
public class DataPointInSplittingDaoImpl implements DataPointInSplittingDao {
	...
	private static final String HQL_BY_DATASET_NAME_AND_SPLITTING_NAME = 
			"select distinct dpis from DataPointInSplitting dpis "
			+ "join fetch dpis.splitting s "
	...
	public List<DataPointInSplitting> findByDatasetNameAndSplittingName(String datasetName, String splittingName, Session session) {
		...
		return (List<DataPointInSplitting>) query.list();
	}
