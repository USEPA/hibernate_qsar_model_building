...
select m.id, m.dataset_name,m.descriptor_set_name,m2.name as method_name,m.fk_descriptor_embedding_id,ms.statistic_value from qsar_models.models m
join qsar_models.methods m2 on m.fk_method_id = m2.id
...
where m.dataset_name like 'ECOTOX_2024_12_12_96HR_%'  and s.name='MAE_Test' and descriptor_set_name ='WebTEST-default' and m2.name='xgb_regressor_1.4' and m.fk_descriptor_embedding_id is not null
