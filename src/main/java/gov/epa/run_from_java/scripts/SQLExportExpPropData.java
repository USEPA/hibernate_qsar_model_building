...
* @author TMARTI02
*/
public class ExportExpPropData {
...
dpc.property_value as propertyValue,u."name" as propertyUnits,
...
join qsar_datasets.data_point_contributors dpc on dpc.fk_data_points_id =dp.id
...
-- Simpler version
select p."name" as property,dpc.dtxsid,  dpc.property_value as propertyValue,u."name" as propertyUnits,
ps."name" as public_source_name,ps.description as public_source_description ,ps.url as public_source_url,
